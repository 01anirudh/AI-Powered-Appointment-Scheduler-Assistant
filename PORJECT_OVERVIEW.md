...
> "Hello! I'm excited to present my **AI-Powered Appointment Scheduler Assistant** - an intelligent system that combines OCR, Natural Language Processing, and AI to revolutionize medical appointment booking.
>
> This project uses **Google Gemini 2.5 Flash** for entity extraction, **Mistral Pixtral Vision Model** for OCR, and modern web technologies to create a seamless booking experience. Users can schedule appointments by simply typing naturally or uploading a photo of their appointment notes."

---

### Problem Statement (45 seconds)

> "Traditional appointment booking systems face several challenges:
> - **Manual data entry** is time-consuming and error-prone
> - Patients often have handwritten prescriptions or appointment notes
> - Extracting structured data from natural language is complex
> - Typos and unclear requests lead to booking errors
>
> My solution addresses all these issues using advanced AI technology that understands natural language, reads handwriting, and intelligently asks for clarification when needed."
...
> - **Google Gemini 2.5 Flash** - Natural language understanding and entity extraction
> - **Mistral Pixtral Vision** - State-of-the-art OCR for handwriting recognition
> - **date-fns** - Intelligent date/time parsing with timezone support
> - **Zod** - Runtime type validation
> - **Multer** - Secure file upload handling
>
> **Frontend:**
> - Vanilla JavaScript with modern glassmorphism design
> - Responsive layout with animated backgrounds
> - Real-time feedback and confidence indicators
>
> The architecture follows clean separation of concerns with dedicated services for AI, OCR, and normalization."
...
>
> **1. Input Layer** - Users submit text or images via a beautiful web interface
>
> **2. Processing Layer:**
> - Images go through Mistral Pixtral for OCR extraction
> - Text (from OCR or direct input) is analyzed by Google Gemini
> - Entities are extracted: date phrases, time phrases, and departments
>
> **3. Intelligence Layer:**
> - Normalization service converts natural language to ISO 8601 format
> - Confidence scoring ensures data quality
> - Ambiguity detection flags unclear requests
> - Automatic typo correction improves accuracy
>
> **4. Output Layer:**
> - Structured appointment data with normalized dates/times
> - Confidence scores for transparency
> - Clear clarification messages when needed"
...
>
> **Text-Based Booking:**
> [Demo: Type 'Book a dentist appointment tomorrow at 3pm']
> - The AI extracts 'tomorrow' as the date phrase
> - Identifies '3pm' as the time
> - Recognizes 'dentist' as the department
> - Normalizes to actual date and 24-hour format
>
> **Natural Language Understanding:**
> [Demo: 'I need to see cardiology next Friday at 10 in the morning']
> - Handles relative dates like 'next Friday'
> - Understands casual time expressions
> - Provides 95%+ confidence scores
>
> **Image Upload with OCR:**
> [Demo: Upload handwritten note]
> - Mistral Pixtral extracts text with 85-95% accuracy
> - Gemini processes the extracted text
> - Complete appointment scheduled in 2-3 seconds
>
> **Smart Clarification:**
> [Demo: 'Book an appointment next week']
> - System detects missing information
> - Asks for specific details: time and department
...
> "This system has numerous practical applications:
> - **Hospitals & Clinics** - Streamline appointment booking from patient notes
> - **Telemedicine Platforms** - Process requests from chat or images
> - **Healthcare Apps** - Integrate AI-powered scheduling
> - **Administrative Staff** - Reduce manual data entry
> - **Patients** - Book using natural language or prescription photos"
...
> - **Practical AI application** solving real-world healthcare problems
> - **Modern full-stack development** with cutting-edge technologies
> - **Clean code architecture** following best practices
> - **User-centric design** prioritizing experience and accuracy
>
> The project is fully functional, well-documented, and ready for production deployment. Thank you!"
